...
var ToDoMixApp = function (_React$Component) {
  _inherits(ToDoMixApp, _React$Component);

  function ToDoMixApp(props) {
    _classCallCheck(this, ToDoMixApp);

    var _this = _possibleConstructorReturn(this, (ToDoMixApp.__proto__ || Object.getPrototypeOf(ToDoMixApp)).call(this, props));
  ...
  _createClass(ToDoMixApp, [{
    ...
    value: function handlePick() {
      var randumNum = Math.floor(Math.random() * this.state.options.length);
      var option = this.state.options[randumNum];
      alert(option);
    }
    //handleAddoption
...
var Action = function Action(props) {
  return React.createElement(
    ...
    React.createElement(
      "button",
      { disabled: !props.hasOptions > 0, onClick: props.handlePick },
      "What should I do?"
    )
  );
};
...
ReactDOM.render(React.createElement(ToDoMixApp, null), document.getElementById("root"));
